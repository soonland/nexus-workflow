...
describe('POST /api/organizations/[id]/archive', () => {
  beforeEach(() => {
    vi.resetAllMocks()
  })
  ...
  it('should return 403 when role is employee', async () => {
    ...
    const req = new NextRequest('http://localhost/api/organizations/org-1/archive')
  ...
  it('should return 200 and set status to archived', async () => {
    ...
    const updated = { id: 'org-1', status: 'archived', owner: null }
